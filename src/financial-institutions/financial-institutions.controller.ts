...
export class FinancialInstitutionsController {
  constructor(private readonly financialInstitutionsService: FinancialInstitutionsService) {}

  @Post()
  create(@Body() createFinancialInstitutionDto: CreateFinancialInstitutionDto) {
    return this.financialInstitutionsService.create(createFinancialInstitutionDto);
  }
  ...
  update(@Param('id') id: string, @Body() updateFinancialInstitutionDto: UpdateFinancialInstitutionDto) {
    return this.financialInstitutionsService.update(+id, updateFinancialInstitutionDto);
  }
